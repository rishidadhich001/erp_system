    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          }, icon: Icon(Icons.refresh,color: bgcolor,))
        ],
        title: Text(
          'ERP System',
          style: TextStyle(
      ...
      body: Column(
        children: [
          Row(
            children: [
              Expanded(child: textbox(label: 'Search', txtController: textSearch)),
              IconButton(onPressed: () {
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(image: search['image']==null?NetworkImage(img):MemoryImage(search['image']))
                    ),
                  ),
                  Padding(
                    padding:
